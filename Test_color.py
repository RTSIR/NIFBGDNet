...
parser.add_argument('--weightsPath',dest='weightsPath',type=str,default='./Pretrained_models/NIFBGDNet_Color.h5',help='pathOfTrainedCNN')
...
for i in range(0,lenth):
    ...
    cv2.imwrite("./Test_Results/Color/"+str(i+1)+"_NIFBGDNet_Color.png",255.*z)
